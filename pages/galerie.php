            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="send-photo" action="../controller.php" method="POST">
                            <input type="hidden" name="form" value="galerie">
                            <input type="text" name="photo" placeholder="Photo">
                            <textarea name="" id="" cols="30" rows="10" type="text" name="descriptif" placeholder="Descriptif"></textarea>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn annuler" data-bs-dismiss="modal">Annuler</button>
                        <button form="send-photo" type="submit" class="btn enregistrer">Enregistrer</button>
                    </div>
                </div>
            </div>
        </div>
